pkgname=bibata-adaptabreath-cursor-git
pkgver=0.3.1
pkgrel=1
pkgdesc="Bibata Based Cursor Theme Made For AdaptaBreath."
arch=('any')
url="https://gitlab.com/cscs/Bibata_AdaptaBreath/"
license=('GPL')
makedepends=('inkscape' 'xorg-xcursorgen' 'gtk-engine-murrine')
source=("https://gitlab.com/cscs/Bibata_AdaptaBreath/-/archive/master/Bibata_AdaptaBreath-master.tar.gz")
sha256sums=(SKIP)

build() {
	cd "$srcdir/Bibata_AdaptaBreath-master"
...
package() {
	...
	mv "$srcdir/Bibata_AdaptaBreath-master/Bibata_AdaptaBreath" "$pkgdir/usr/share/icons/Bibata_AdaptaBreath"
} 
